...
//@Configuration
//@EnableSwagger2
public class SystemManageSwaggerConfigurer {
    /**
     * 创建API基本信息
     *
     * @return
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("系统管理")
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.chinamobile.pallet.system.manage"))
    ...
    private ApiInfo apiInfo() {// 创建API的基本信息，这些信息会在Swagger UI中进行显示
        return new ApiInfoBuilder()
                ...
                .description("系统管理服务提供的 RestFul APIs")// API描述

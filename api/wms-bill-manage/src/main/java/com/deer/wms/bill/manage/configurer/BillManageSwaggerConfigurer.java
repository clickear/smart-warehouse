...
//@Configuration
//@EnableSwagger2
public class BillManageSwaggerConfigurer {
    /**
     * 创建API基本信息
     *
     * @return
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("出入库信息")
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.deer.bill.manage"))

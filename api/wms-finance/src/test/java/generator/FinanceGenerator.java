...
public class FinanceGenerator {
    public static void main(String[] args) {
        ...
        configurer.setBasePackage("com.deer.wms.finance");
        configurer.setAuthor("");

        //设置子模块名称(如果要生成子模块的代码，一定要设置该值，否则代码将会生成到父项目中了)
        configurer.setModuleName("/wms-finance");

        //设置需要生成的表
        configurer.getTables().add(new Table("manage_ar", null, "ar_id", "Integer"));
        configurer.getTables().add(new Table("manage_pay", null, "id", "Integer"));

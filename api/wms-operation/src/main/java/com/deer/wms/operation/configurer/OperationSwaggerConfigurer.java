...
//@Configuration
//@EnableSwagger2
public class OperationSwaggerConfigurer {
    /**
     * 创建API基本信息
     *
     * @return
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("业务操作")
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.deer.operation"))

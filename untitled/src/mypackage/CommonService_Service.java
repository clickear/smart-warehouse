 ...
 * 
 */
@WebServiceClient(name = "CommonService", targetNamespace = "http://demo1.example.com", wsdlLocation = "http://localhost:9089/webservice/CommonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName COMMONSERVICE_QNAME = new QName("http://demo1.example.com", "CommonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9089/webservice/CommonService?wsdl");
    ...
    public CommonService getCommonServiceImplPort() {
        return super.getPort(new QName("http://demo1.example.com", "CommonServiceImplPort"), CommonService.class);
    }
    ...
    public CommonService getCommonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://demo1.example.com", "CommonServiceImplPort"), CommonService.class, features);
    }

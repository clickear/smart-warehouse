...
(function () {
    let $vue = new Vue({
        el: '.result-create-allocation-hook',
        data: {
            info:{
                orderNo: '',
                orderLeaseId: '',
        ...
        mounted: function () {
            ...
            this.$nextTick(() => {
                ...
                let tableHookName = '.result-create-allocation-table-hook';
                ...
                var $tableHook = $accountBox.find(tableHookName).bootstrapTable({
                    scrollbar: 'result-create-allocation-table-body',
                    ...
                    columns: [
                        ...
                        {
                            field: 'orderNo', title: '录入托盘总数', align: 'center', fixedLeft: true
                        },
                        {
                            field: 'totalQuantity', title: '上传账户', align: 'center', fixedLeft: true
                        },
                        {
                            field: 'leaseMode', title: '设备类型', align: 'center', fixedLeft: true,
                        ...
                        {
                            field: 'leaseType', title: '扫描类型', align: 'center', fixedLeft: true,
                            formatter: function (value, row, index) {
                                /* 1短租；2长租； */
                        ...
                        {
                            field: 'count', title: '扫描录入日期', align: 'center', fixedLeft: true,formatter: function (value, row, index) {
                        ...
                        },
                        {
                            ...
                            events: {
                                'click .detail-account': function (e, value,rowData, index) {
                                    M.Page.emit(URI.RUN.PATCH_ALLOCATION.ADD.RESULT.DETAIL.PAGE);
                                    IOT.setSessionStore(URI.RUN.PATCH_ALLOCATION.ADD.RESULT.DETAIL.PAGE, JSON.stringify(rowData));
                                    return false;
                                }
                            },
                            formatter: function (value, row, index) {
                                return `<a class="detail-account">明细</a>`;
                            }
                        }

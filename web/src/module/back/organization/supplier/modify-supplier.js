...
(function () {
    let storeParams = JSON.parse(IOT.getSessionStore(URI.ORGANIZATION.SUPPLIER.MODIFY.PAGE));
    const CONTRAST = {
    ...
    let $vue = new Vue({
        ...
        created: function () {
            IOT.getServerData(URI.ORGANIZATION.SUPPLIER.MODIFY.DATA, storeParams, (ret) => {
                if (ret.code === 200) {
                    let data = ret.data;
            ...
            this.$nextTick(() => {
                ...
                $createClient.find('.form-hook').validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        IOT.doFileUpload2(URI.ORGANIZATION.SUPPLIER.MODIFY.SAVE, params, function (result) {
                            IOT.hideOverlay();

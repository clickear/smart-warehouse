...
(function () {
    let storeParams = JSON.parse(IOT.getSessionStore(URI.ORGANIZATION.CLIENT.DETAIL.PAGE));
    let $vue = new Vue({
        ...
        created: function () {
            IOT.getServerData(URI.ORGANIZATION.CLIENT.DETAIL.DATA, storeParams, (ret) => {
                if (ret.code === 200) {
                    let data = ret.data;

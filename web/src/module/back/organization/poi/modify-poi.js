...
(function () {
    let storeParams = JSON.parse(IOT.getSessionStore(URI.ORGANIZATION.POI.MODIFY.PAGE));
    const CONTRAST = {
    ...
    let $vue = new Vue({
        ...
        created: function () {
            IOT.getServerData(URI.ORGANIZATION.POI.MODIFY.DATA, storeParams, (ret) => {
                if (ret.code === 200) {
                    let data = ret.data;
                    ...
                    this.info.linkmanAddress1 = data.linkmanAddress;
                    this.info.registeredAddress1 = data.registeredAddress;
                } else {
            ...
            this.$nextTick(() => {
                ...
                $createClient.find('.form-hook').validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        IOT.doFileUpload2(URI.ORGANIZATION.POI.MODIFY.SAVE, params, function (result) {
                            IOT.hideOverlay();

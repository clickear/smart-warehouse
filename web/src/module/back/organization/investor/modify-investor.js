...
(function () {
    let storeParams = JSON.parse(IOT.getSessionStore(URI.ORGANIZATION.INVESTOR.MODIFY.PAGE));
    const CONTRAST = {
    ...
    let $vue = new Vue({
        ...
        created: function () {
            IOT.getServerData(URI.ORGANIZATION.INVESTOR.MODIFY.DATA, storeParams, (ret) => {
                if (ret.code === 200) {
                    let data = ret.data;
            ...
            this.$nextTick(() => {
                ...
                $createClient.find('.form-hook').validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        IOT.doFileUpload2(URI.ORGANIZATION.INVESTOR.MODIFY.SAVE, params, function (result) {
                            IOT.hideOverlay();

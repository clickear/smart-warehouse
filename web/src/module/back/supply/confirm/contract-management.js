...
(function () {
    ...
    let orderNo = JSON.parse(IOT.getSessionStore(URI.SUPPLY.CONFIRM.DETAIL.CONTRACTMANAGEMENT.PAGE));
    let $vue = new Vue({
        ...
        mounted: function () {
            this.$nextTick(() => {
                        ...
                        },
                        {
                            ...
                            events: {
                                'click .detail-account': function (e, value, row, index) {
                                    IOT.setSessionStore(URI.SUPPLY.CONFIRM.DETAIL.CONTRACTMANAGEMENT.PREVIEW, JSON.stringify(row));
                                    M.Page.emit(URI.SUPPLY.CONFIRM.DETAIL.CONTRACTMANAGEMENT.PREVIEW);
                                    return false;
                                }
                            },
                            formatter: function (value, row, index) {
                ...
                if (!M.Authority.checkAuthority('product-order-confirm-contract-detail')) {
